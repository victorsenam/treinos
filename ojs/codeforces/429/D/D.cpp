...
#define pb push_back
 ...
 typedef ll cood; cood eps = 0; cood inf = LLONG_MAX; // risky: XXX, untested: TODO
...
cood closest_pair (vec * v, vec * w, int l, int r, bool sorted = 0) { // nlg | TODO (AC on cf, no test)
	if (l + 1 >= r) return inf;
